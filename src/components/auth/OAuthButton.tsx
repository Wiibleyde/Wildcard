...
const providers: Record<OAuthProvider, { label: string; icon: React.ReactNode; className: string }> = {
  ...
  discord: {
    label: "Discord",
    className: "bg-[#5865F2] text-white hover:bg-[#4752C4] active:bg-[#3c45a5]",
    icon: (
...
export function OAuthButton({ provider, labelOverride }: { provider: OAuthProvider; labelOverride?: string }) {
